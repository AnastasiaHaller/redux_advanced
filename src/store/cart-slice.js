  ...
  return async (dispatchAction) => {
    dispatchAction(
      mainActions.showStatusMessage({
        status: 'pending',
        title: 'Sending Data',
        message: 'The cart data is sent to the server...',
      })
    );
    ...
    try {
      ...
      dispatchAction(
        mainActions.showStatusMessage({
          status: 'success',
          title: 'Data Sending Successful',
          message: 'The cart data has been successfully sent to the server!',
        })
      );
    } catch (error) {
      dispatchAction(
    ...
    try {
      ...
      dispatchAction(
        mainActions.showStatusMessage({
          status: 'error',
          title: 'The request failed',
          message: 'Error while retrieving cart data!',
        })
      );
    }
  };
